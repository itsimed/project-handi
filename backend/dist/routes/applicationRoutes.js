 ...
 * IMPORTANT: Cette route doit être définie AVANT /:id pour éviter les conflits de routage
 */
 ...
 * @desc    Récupère toutes les candidatures pour une offre spécifique (Recruteur uniquement pour ses propres offres)
 * @access  Privé (Rôle: RECRUITER, ADMIN)
 * IMPORTANT: Cette route doit être définie AVANT /:id pour éviter les conflits de routage
 */
router.get('/offer/:offerId', authMiddleware_1.authenticateToken, (0, authMiddleware_1.authorizeRole)(['RECRUITER', 'ADMIN']), applicationController_1.getApplicationsByOfferId);
/**
 * @route   GET /api/v1/applications/:id
 * @desc    Récupère les détails d'une candidature spécifique (Candidat uniquement ses propres candidatures)
 * @access  Privé (Rôle: APPLICANT)
 */
router.get('/:id', authMiddleware_1.authenticateToken, (0, authMiddleware_1.authorizeRole)(['APPLICANT']), applicationController_1.getApplicationById);
/**
