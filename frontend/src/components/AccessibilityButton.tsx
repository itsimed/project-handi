  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 left-4 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 z-50"
        style={{
